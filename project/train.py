...
dir_img = ('/local/scratch/TuoDou/image')
dir_mask = ('/local/scratch/TuoDou/mask')
dir_checkpoint = Path('./checkpoints_5/')
...
def train_model(
    ...
    train_set = Subset(dataset, indices=range(0, n_train))
    val_set = Subset(dataset, indices=range(n_train, len(dataset)))
